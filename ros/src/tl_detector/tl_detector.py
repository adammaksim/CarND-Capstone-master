...
class TLDetector(object):
    ...
    def get_closest_waypoint(self, pose, current_waypoint_index=0, before=False):
        ...
        #TODO implement
        if before:
            return waypoint_help_function.get_closest_waypoint_before_index(self.waypoints, pose, current_waypoint_index,
                                                                     self.waypoints_num)
        else:
            return waypoint_help_function.get_closest_waypoint_ahead_index(self.waypoints, pose, current_waypoint_index,
                                                                    self.waypoints_num)
    ...
    def get_closest_stop_line_waypoint(self, pose):
        ...
        return waypoint_help_function.get_closest_waypoint_before_index(self.waypoints
    ...
    def get_closest_stop_line_pose(self, closest_waypoint_index):
        ...
        for stop_line in light_stop_line_positions:
            ...
            distance = waypoint_help_function.direct_position_distance(stop_line_position, waypoint.pose.pose.position)
    ...
    def get_nearby_traffic_light(self, current_waypoint):
        ...
        if closest_light_waypoint:
    		distance_to_traffic_light = waypoint_help_function.direct_position_distance(\
