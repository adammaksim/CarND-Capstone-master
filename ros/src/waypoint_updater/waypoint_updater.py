...
MAX_DEC = 0.4 # Max Deceleration
LOOKAHEAD_WPS = 200 # Number of waypoints we will publish. You can change this number

# Update wayponit velocity
...
# Decelearate car before traffic light
def decelerate_car(final_waypoints, current_waypoint_index, stop_waypoint_index):
    ...
    for i, wp in enumerate(final_waypoints):
        ...
        dist = waypoint_help_function.linear_arc_distance(final_waypoints, i, stop_idx)
...
class WaypointUpdater(object):
    ...
    def get_final_waypoints(self):
        range_indices_list = waypoint_help_function.get_cyclic_range_indices(0, self.get_current_waypoint_index(), self.base_waypoints_num, LOOKAHEAD_WPS)
    ...
    def update_waypoints(self):
        ...
        # get closest waypoint index to car
        closet_waypoint_index = waypoint_help_function.get_closest_waypoint_ahead_index(self.get_basic_waypoints(),
        ...
        # set velocity based on traffic lights and obstacles
